...
import TagBoxInput from './components/tagBoxInput';
    ...
    render() {
        return (
            <Stack.Navigator>
                ...
                <Stack.Screen
                    name={Routes.REF}
                    component={RefComponent}></Stack.Screen>
                <Stack.Screen
                    name={Routes.ANIM}
                    component={AnimComponent}></Stack.Screen>
                <Stack.Screen
                    name={Routes.TAG_BOX}
                    component={TagBox}></Stack.Screen>
                <Stack.Screen
                    name={Routes.TAG_INPUT_BOX}
                    component={TagBoxInput}></Stack.Screen>
            </Stack.Navigator>
        );
